...
Use CSS Modules for styling by adding a `component_name.module.scss` file (or `styles.module.scss` if the styles affect multiple subcomponents). Learn more in our [Styling docs](/dev/frontend/css-and-styling).
