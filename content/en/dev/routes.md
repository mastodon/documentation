...
## Explanation of routes <a id="routes"></a>
...
### How routes are constructed <a id="router"></a>
...
### Available methods <a id="methods"></a>
...
## .well-known <a id="well-known"></a>

### /.well-known/host-meta <a id="host-meta"></a>

Extensible Resource Descriptor \(XRD\). Advertises existence of Webfinger.

### /.well-known/nodeinfo <a id="nodeinfo"></a>
