...
## Scopes explained <a id="scopes"></a>
...
### Authorize the user <a id="login"></a>
...
### Interact with timelines <a id="timelines"></a>
...
### Interact with other users <a id="accounts"></a>
...
### Receive notifications <a id="notifications"></a>
...
### Discovery features <a id="discovery"></a>
...
### Use safety features <a id="safety"></a>
...
### Manage account info <a id="manage"></a>
