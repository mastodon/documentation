...
### Creating HTTP signatures <a id="http-sign"></a>
...
### Verifying HTTP signatures <a id="http-verify"></a>
...
## Linked Data Signatures <a id="ld"></a>
...
### Creating LD signatures <a id="ld-sign"></a>
...
### Verifying LD signatures <a id="ld-verify"></a>
