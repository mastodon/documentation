...
この機能を使用するには、作成ボックスの下にある ![CW icon](screenshots/compose-cw.png) "CW"アイコンをクリックします。 これにより、「コンテンツの警告」というラベルの付いた別のテキストボックスが追加されます。投稿の"本文"の内容を簡潔に要約したものをここに入力し、本来の非表示にしたい投稿は"今何してる？"に入力します。
