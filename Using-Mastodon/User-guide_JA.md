...
* [前書き](User-guide_JA.md#intro)
  * [分散と連合](User-guide_JA.md#decentralization-and-federation)
* [使いはじめる](User-guide_JA.md#getting-started)
  * [プロフィールを設定する](User-guide_JA.md#setting-up-your-profile)
  * [メール通知](User-guide_JA.md#e-mail-notifications)
  * [テキスト投稿](User-guide_JA.md#text-posts)
    * [コンテンツ警告（CW）](User-guide_JA.md#content-warnings)
    * [ハッシュタグ](User-guide_JA.md#hashtags)
    * [ブーストとお気に入り](User-guide_JA.md#boosts-and-favourites)
  * [画像の投稿](User-guide_JA.md#posting-images)
  * [ユーザのフォロー](User-guide_JA.md#following-other-users)
  * [通知](User-guide_JA.md#notifications)
  * [モバイルアプリ](User-guide_JA.md#mobile-apps)
  * [連合タイムライン](User-guide_JA.md#the-federated-timeline)
  * [ローカルタイムライン](User-guide_JA.md#the-local-timeline)
  * [検索](User-guide_JA.md#searching)
  * [リスト](User-guide_JA.md#lists)
* [プライバシー、安全、セキュリティ](User-guide_JA.md#privacy-safety-and-security)
  * [二要素認証](User-guide_JA.md#two-factor-authentication)
  * [アカウントのプライバシー](User-guide_JA.md#account-privacy)
  * [トゥートのプライバシー](User-guide_JA.md#toot-privacy)
  * [ブロック](User-guide_JA.md#blocking)
  * [トゥートやユーザの通報](User-guide_JA.md#reporting-toots-or-users)
* [疑問がある場合は？](User-guide_JA.md#still-questions)
...
別のブラウザタブで既にユーザプロフィールを開いている場合、他のMastodonインスタンスとほとんどのOStatus関連のインスタンスには、プロフィールページに  "フォロー" または  "購読 " ボタンが必要です。これによって、フルユーザ名の入力を求められるようになります。(アカウントがMastodon.socialにある場合は、myaccount@Mastodon.socialと入力します)
...
![Notification Settings icon](screenshots/notifications-settings.png) 通知に表示される通知の種類は、画面上部にある「通知設定」アイコンをクリックし、各通知のチェックボックスを選択することでを表示の有無を設定できます。

![Clear icon](screenshots/notifications-clear.png) 通知が散らかってきたと感じたら、画面上部にある「クリア」アイコンをクリックすれば、列ごと内容を消去します。

![Preferences icon](screenshots/preferences.png) フォローしていないか、またはされていないユーザからの通知を完全に無効にすることもできます。設定するには、作成列の「ユーザ設定」アイコンをクリックします。左側メニューのユーザ設定から「通知をブロック」オプションにて設定します。
...
![Federated Timeline icon](screenshots/federated-timeline.png)連合タイムラインを表示するには、作成列の"連合タイムライン"アイコン、またはスタートのボタンをクリックします。連合タイムラインを非表示にするには、上部にある"戻る"をクリックします。
